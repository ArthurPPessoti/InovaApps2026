  ...
  return (
    <div className="company-detail-page">
      ...
      <section className="client-hero">
        ...
        <div className="client-value"><span>Receita mensal total</span><strong>{formatCurrency(portfolio.monthlyRevenue)}</strong><small>{products.length} {products.length === 1 ? "produto contratado" : "produtos contratados"}</small></div>
      </section>
