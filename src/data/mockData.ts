...
export const companies: CompanyMock[] = [
  ...
  { id: "educacional-delta", name: "Educacional Delta", segment: "Educação", owner: "Marina Costa", nps: null, paymentDelay: 2, relationshipRiskScore: 69, dataSource: "mock" },
  { id: "servicos-prisma", name: "Serviços Prisma", segment: "Serviços", owner: "Paulo Nunes", nps: 8, paymentDelay: 0, relationshipRiskScore: 64, dataSource: "mock" },
  { id: "rotas-sul", name: "Rotas Sul", segment: "Logística", owner: "Ana Lima", nps: 3, paymentDelay: 0, relationshipRiskScore: 61, dataSource: "mock" },
  { id: "grupo-aurora", name: "Grupo Aurora", segment: "Varejo", owner: "Caio Martins", nps: 7, paymentDelay: 0, relationshipRiskScore: 57, dataSource: "mock" },
  { id: "porto-sul", name: "Porto Sul Distribuição", segment: "Logística", owner: "Marina Costa", nps: 9, paymentDelay: 0, relationshipRiskScore: 28, dataSource: "mock" },
  { id: "rede-vitta", name: "Rede Vitta Farmácias", segment: "Varejo", owner: "Ana Lima", nps: 8, paymentDelay: 0, relationshipRiskScore: 24, dataSource: "mock" },
  { id: "mercado-leste", name: "Mercado Leste", segment: "Varejo", owner: "Marina Costa", nps: 5, paymentDelay: 0, relationshipRiskScore: 72, dataSource: "mock" },
  { id: "clinica-vida", name: "Clínica Vida", segment: "Saúde", owner: "Paulo Nunes", nps: 3, paymentDelay: 0, relationshipRiskScore: 81, dataSource: "mock" },
  { id: "transportes-norte", name: "Transportes Norte", segment: "Logística", owner: "Ana Lima", nps: 7, paymentDelay: 18, relationshipRiskScore: 74, dataSource: "mock" },
  { id: "escola-conecta", name: "Escola Conecta", segment: "Educação", owner: "Caio Martins", nps: null, paymentDelay: 0, relationshipRiskScore: 76, dataSource: "mock" },
  { id: "industria-vale", name: "Indústria Vale", segment: "Indústria", owner: "Caio Martins", nps: 4, paymentDelay: 0, relationshipRiskScore: 88, dataSource: "mock" },
  { id: "grupo-central", name: "Grupo Central", segment: "Serviços", owner: "Paulo Nunes", nps: 6, paymentDelay: 0, relationshipRiskScore: 73, dataSource: "mock" },
];
